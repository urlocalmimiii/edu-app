...
const success = require("../assets/illustrations/success.png");
const successDark = require("../assets/illustrations/success_dark.png");
...
const background = require("../assets/illustrations/background_illustration.png");
